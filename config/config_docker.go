...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"pteranodon_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"pteranodon_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the pteranodon containers are started with user namespace
	// remapping disabled
